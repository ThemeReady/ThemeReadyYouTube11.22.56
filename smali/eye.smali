...
.method public constructor <init>(Landroid/app/Activity;Locd;Lsyw;Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Leye;->b:Landroid/support/v7/widget/CardView;

    .line 44
    iget-object v0, p0, Leye;->b:Landroid/support/v7/widget/CardView;
    ...
    iput-object v0, p0, Leye;->c:Landroid/widget/ImageView;

    .line 48
    new-instance v0, Lnmx;

    iget-object v1, p0, Leye;->b:Landroid/support/v7/widget/CardView;

    invoke-direct {v0, p3, v1}, Lnmx;-><init>(Lsyw;Landroid/view/View;)V

    iput-object v0, p0, Leye;->f:Lnmx;
...
.method protected final synthetic a(Lnnf;Ltjl;)V
    ...
    .line 1058
    iget-object v0, p0, Leye;->f:Lnmx;

    .line 2031
    iget-object v1, p1, Lnac;->a:Lnaa;

    .line 1059
    iget-object v2, p2, Ltrz;->d:Ltvj;
    ...
    .line 1062
    iget-object v0, p0, Leye;->a:Locd;

    iget-object v1, p0, Leye;->c:Landroid/widget/ImageView;

    iget-object v2, p2, Ltrz;->a:Luqm;
    ...
    .line 2039
    iget-object v1, p2, Ltrz;->e:Landroid/text/Spanned;

    if-nez v1, :cond_0

    .line 2040
    iget-object v1, p2, Ltrz;->b:Ltca;
    ...
    iput-object v1, p2, Ltrz;->e:Landroid/text/Spanned;
    ...
    .line 2064
    iget-object v1, p2, Ltrz;->f:Landroid/text/Spanned;

    if-nez v1, :cond_1

    .line 2065
    iget-object v1, p2, Ltrz;->c:Ltca;
    ...
    iput-object v1, p2, Ltrz;->f:Landroid/text/Spanned;
