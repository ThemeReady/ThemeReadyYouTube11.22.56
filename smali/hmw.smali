...
.field private static C:Lhne;

.field private static D:Z

.field private static E:Lhao;

.field private static F:Lbov;

.field private static G:Ljava/util/Random;

.field private static H:Lhax;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lhmw;->B:J

    sput-boolean v2, Lhmw;->D:Z

    const/4 v0, 0x0

    sput-object v0, Lhmw;->E:Lhao;

    new-instance v0, Ljava/util/Random;

    invoke-direct {v0}, Ljava/util/Random;-><init>()V

    sput-object v0, Lhmw;->G:Ljava/util/Random;

    .line 34000
    sget-object v0, Lhax;->c:Lhax;

    .line 0
    sput-object v0, Lhmw;->H:Lhax;

    sput-boolean v2, Lhmw;->J:Z

    sput-boolean v2, Lhmw;->K:Z

    sput-boolean v2, Lhmw;->L:Z

    sput-boolean v2, Lhmw;->M:Z
...
.method protected constructor <init>(Landroid/content/Context;Lhnd;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lhmu;-><init>(Landroid/content/Context;Lhnd;)V

    new-instance v0, Lbov;

    invoke-direct {v0}, Lbov;-><init>()V

    sput-object v0, Lhmw;->F:Lbov;
...
.method private static a(Landroid/content/Context;Lhnd;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhmw;->z:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhmw;->o:Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, v0}, Lhmx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p1, v0}, Lhnd;->a([B)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lhmw;->z:Ljava/lang/String;
    :try_end_1
...
.method private static a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lhmw;->C:Lhne;

    invoke-virtual {v1, p0, p1}, Lhne;->a([BLjava/lang/String;)[B
...
.method private static a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhmw;->p:Ljava/lang/reflect/Method;
...
.method protected static a(II)V
    ...
    .prologue
    .line 0
    sget-boolean v0, Lhmw;->M:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lhmw;->J:Z

    if-eqz v0, :cond_1

    sget-object v0, Lhmw;->E:Lhao;

    if-eqz v0, :cond_1

    sget-object v0, Lhmw;->E:Lhao;

    sget-object v1, Lhmw;->F:Lbov;

    invoke-static {v1}, Lhmj;->a(Lhmj;)[B

    move-result-object v1

    invoke-virtual {v0, v1}, Lhao;->a([B)Lhaq;

    move-result-object v0

    .line 32000
    iget-object v1, v0, Lhaq;->a:Lhmr;

    iput p1, v1, Lhmr;->d:I

    .line 0
    invoke-virtual {v0, p0}, Lhaq;->a(I)Lhaq;

    sget-object v1, Lhmw;->i:Lhbm;
    ...
    invoke-interface {v2, v1, v0}, Lhat;->a(Lhbm;Lcom/google/android/gms/clearcut/LogEventParcelable;)Lhbs;
...
.method protected static declared-synchronized a(Ljava/lang/String;Landroid/content/Context;Lhnd;)V
    .locals 21
    ...
    invoke-direct {v2, v0}, Lhne;-><init>(Lhnd;)V

    sput-object v2, Lhmw;->C:Lhne;

    sput-object p0, Lhmw;->y:Ljava/lang/String;

    invoke-static/range {p1 .. p1}, Lgqu;->a(Landroid/content/Context;)V
    :try_end_1
    .catch Lhmx; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_1 .. :try_end_1} :catch_2
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 1000
    :try_start_2
    sget-object v2, Lhmw;->C:Lhne;

    .line 2000
    const-string v3, "QpmJ8ul06jlIzFufLfsNAWUj2KYEV5t//bwTAlu38Ok="

    .line 1000
    invoke-virtual {v2, v3}, Lhne;->a(Ljava/lang/String;)[B
    ...
    .line 1000
    invoke-virtual {v2, v5, v3}, Lhne;->a([BLjava/lang/String;)[B
    ...
    .catch Lhnf; {:try_start_2 .. :try_end_2} :catch_5
    .catch Ljava/lang/NoSuchMethodException; {:try_start_2 .. :try_end_2} :catch_6
    .catch Ljava/lang/NullPointerException; {:try_start_2 .. :try_end_2} :catch_7
    .catch Lhmx; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v3, v2}, Lhmx;-><init>(Ljava/lang/Throwable;)V

    throw v3
    :try_end_3
    .catch Lhmx; {:try_start_3 .. :try_end_3} :catch_1
    ...
    .line 1000
    invoke-static {v5, v6}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v8}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v9}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v10}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v11}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v12}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v13}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v14}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v15}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v0}, Lhmw;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sput-object v6, Lhmw;->j:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->m:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->n:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->o:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->p:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->q:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->r:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->s:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->t:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->u:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->v:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmw;->w:Ljava/lang/reflect/Method;
    ...
    sput-object v2, Lhmw;->x:Ljava/lang/reflect/Method;
    :try_end_5
    ...
    .catch Lhnf; {:try_start_6 .. :try_end_6} :catch_5
    ...
    sput-wide v2, Lhmw;->B:J

    new-instance v2, Ljava/util/Random;

    invoke-direct {v2}, Ljava/util/Random;-><init>()V

    sput-object v2, Lhmw;->G:Ljava/util/Random;
    :try_end_7
    .catch Lhmx; {:try_start_7 .. :try_end_7} :catch_1
    ...
    invoke-direct {v2, v0}, Lhbn;-><init>(Landroid/content/Context;)V

    sget-object v3, Lhao;->b:Lhbf;

    invoke-virtual {v2, v3}, Lhbn;->a(Lhbf;)Lhbn;

    move-result-object v2

    invoke-virtual {v2}, Lhbn;->b()Lhbm;

    move-result-object v2

    sput-object v2, Lhmw;->i:Lhbm;

    .line 30000
    sget-object v2, Lhax;->c:Lhax;

    .line 0
    sput-object v2, Lhmw;->H:Lhax;

    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lhax;->a(Landroid/content/Context;)I
    ...
    :goto_1
    sput-boolean v2, Lhmw;->I:Z

    invoke-static/range {p1 .. p1}, Lgqu;->a(Landroid/content/Context;)V

    sget-object v2, Lgqu;->k:Lgqp;

    invoke-virtual {v2}, Lgqp;->a()Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v3, v5}, Lhao;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    sput-object v2, Lhmw;->E:Lhao;
    :try_end_8
    .catch Ljava/lang/NoClassDefFoundError; {:try_start_8 .. :try_end_8} :catch_8
    .catch Lhmx; {:try_start_8 .. :try_end_8} :catch_1
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_8 .. :try_end_8} :catch_2
    .catchall {:try_start_8 .. :try_end_8} :catchall_1

    :goto_2
    :try_start_9
    sget-object v2, Lhmw;->H:Lhax;

    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lhax;->b(Landroid/content/Context;)I
    ...
    sput-boolean v2, Lhmw;->D:Z
    :try_end_9
    .catch Lhmx; {:try_start_9 .. :try_end_9} :catch_1
    ...
    .catch Lhnf; {:try_start_a .. :try_end_a} :catch_5
    ...
    .catch Lhmx; {:try_start_a .. :try_end_a} :catch_1
    ...
    throw v3
    :try_end_b
    .catch Lhmx; {:try_start_b .. :try_end_b} :catch_1
    ...
    throw v3
    :try_end_c
    .catch Lhmx; {:try_start_c .. :try_end_c} :catch_1
...
.method private static b(Landroid/content/Context;Lhnd;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhmw;->A:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhmw;->r:Ljava/lang/reflect/Method;
...
.method private static c()V
    ...
    sget-boolean v0, Lhmw;->I:Z

    if-eqz v0, :cond_0

    sget-object v0, Lhmw;->i:Lhbm;

    invoke-virtual {v0}, Lhbm;->c()V

    const/4 v0, 0x1

    sput-boolean v0, Lhmw;->M:Z
...
.method private static d(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhmw;->u:Ljava/lang/reflect/Method;
...
.method private static d()V
    ...
    .line 31000
    iget-object v0, v0, Lhao;->c:Lhat;

    const-wide/16 v2, 0x64

    invoke-interface {v0, v2, v3, v1}, Lhat;->a(JLjava/util/concurrent/TimeUnit;)Z
...
.method private static e()Ljava/lang/String;
    ...
    sget-object v0, Lhmw;->y:Ljava/lang/String;
...
.method static e(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhmw;->q:Ljava/lang/reflect/Method;
...
.method private static f()Ljava/lang/Long;
    ...
    sget-object v0, Lhmw;->j:Ljava/lang/reflect/Method;
...
.method private static f(Landroid/content/Context;)Ljava/lang/Long;
    ...
    sget-object v0, Lhmw;->v:Ljava/lang/reflect/Method;
...
.method private static g()Ljava/lang/String;
    ...
    sget-object v0, Lhmw;->n:Ljava/lang/reflect/Method;
...
.method private static g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhmw;->s:Ljava/lang/reflect/Method;
...
.method private static h()Ljava/lang/Long;
    ...
    sget-object v0, Lhmw;->m:Ljava/lang/reflect/Method;
...
.method private static h(Landroid/content/Context;)[I
    ...
    sget-object v0, Lhmw;->t:Ljava/lang/reflect/Method;
...
.method private static i(Landroid/content/Context;)I
    ...
    sget-object v0, Lhmw;->w:Ljava/lang/reflect/Method;
...
.method private static j(Landroid/content/Context;)I
    ...
    sget-object v0, Lhmw;->x:Ljava/lang/reflect/Method;
...
# virtual methods
.method protected b(Landroid/content/Context;)Lbox;
    .locals 8
    ...
    :try_start_0
    invoke-static {}, Lhmw;->c()V

    sget-object v0, Lhmw;->G:Ljava/util/Random;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    invoke-static {}, Lhmw;->g()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbox;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_1
    .catch Lhmx; {:try_start_1 .. :try_end_1} :catch_c
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    :goto_0
    :try_start_2
    invoke-static {}, Lhmw;->e()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbox;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_2
    .catch Lhmx; {:try_start_2 .. :try_end_2} :catch_b
    ...
    iput-object v0, v1, Lbox;->D:Ljava/lang/Long;

    sget-wide v4, Lhmw;->B:J
    ...
    iput-object v0, v1, Lbox;->j:Ljava/lang/Long;

    sget-wide v2, Lhmw;->B:J

    invoke-static {v2, v3}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbox;->l:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_3
    .catch Lhmx; {:try_start_3 .. :try_end_3} :catch_a
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0

    :goto_2
    :try_start_4
    invoke-static {p1}, Lhmw;->g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    iput-object v0, v1, Lbox;->o:Ljava/lang/Long;
    ...
    iput-object v0, v1, Lbox;->p:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_4
    .catch Lhmx; {:try_start_4 .. :try_end_4} :catch_9
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_0

    :goto_3
    :try_start_5
    invoke-static {}, Lhmw;->h()Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbox;->q:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_5
    .catch Lhmx; {:try_start_5 .. :try_end_5} :catch_8
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_0

    :goto_4
    :try_start_6
    sget-boolean v0, Lhmw;->K:Z

    if-eqz v0, :cond_1

    sget-boolean v0, Lhmw;->L:Z

    if-nez v0, :cond_2

    :cond_1
    iget-object v0, p0, Lhmw;->h:Lhnd;

    invoke-static {p1, v0}, Lhmw;->a(Landroid/content/Context;Lhnd;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbox;->m:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_6
    .catch Lhmx; {:try_start_6 .. :try_end_6} :catch_7
    ...
    invoke-static {p1, v0}, Lhmw;->b(Landroid/content/Context;Lhnd;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbox;->n:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_7
    .catch Lhmx; {:try_start_7 .. :try_end_7} :catch_6
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_7} :catch_0

    :goto_6
    :try_start_8
    invoke-static {p1}, Lhmw;->h(Landroid/content/Context;)[I
    ...
    iput-object v2, v1, Lbox;->d:Ljava/lang/Long;
    ...
    iput-object v0, v1, Lbox;->e:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_8
    .catch Lhmx; {:try_start_8 .. :try_end_8} :catch_5
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_8} :catch_0

    :goto_7
    :try_start_9
    invoke-static {p1}, Lhmw;->i(Landroid/content/Context;)I
    ...
    iput-object v0, v1, Lbox;->f:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_9
    .catch Lhmx; {:try_start_9 .. :try_end_9} :catch_4
    .catch Ljava/io/IOException; {:try_start_9 .. :try_end_9} :catch_0

    :goto_8
    :try_start_a
    invoke-static {p1}, Lhmw;->j(Landroid/content/Context;)I
    ...
    iput-object v0, v1, Lbox;->c:Ljava/lang/Long;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_a
    .catch Lhmx; {:try_start_a .. :try_end_a} :catch_3
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_a} :catch_0

    :goto_9
    :try_start_b
    invoke-static {p1}, Lhmw;->d(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v1, Lbox;->r:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lhmw;->a(II)V
    :try_end_b
    .catch Lhmx; {:try_start_b .. :try_end_b} :catch_2
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_b} :catch_0

    :goto_a
    :try_start_c
    invoke-static {p1}, Lhmw;->f(Landroid/content/Context;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, Lbox;->s:Ljava/lang/Long;
...
.method protected c(Landroid/content/Context;)Lbox;
    .locals 8
    ...
    iput-object v0, v2, Lbox;->b:Ljava/lang/String;
    :try_end_1
    .catch Lhmx; {:try_start_1 .. :try_end_1} :catch_7
    ...
    iput-object v0, v2, Lbox;->a:Ljava/lang/String;
    :try_end_2
    .catch Lhmx; {:try_start_2 .. :try_end_2} :catch_6
    ...
    iput-object v0, v2, Lbox;->D:Ljava/lang/Long;
    :try_end_3
    .catch Lhmx; {:try_start_3 .. :try_end_3} :catch_5
    ...
    invoke-static {v0, v3}, Lhmw;->a(II)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_1

    :try_start_5
    iget-object v0, p0, Lhmw;->a:Landroid/view/MotionEvent;

    iget-object v3, p0, Lhmw;->g:Landroid/util/DisplayMetrics;

    invoke-static {v0, v3}, Lhmw;->a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    iput-object v0, v2, Lbox;->g:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbox;->h:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbox;->i:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbox;->t:Ljava/lang/Long;
    ...
    iput-object v0, v2, Lbox;->u:Ljava/lang/Long;
    ...
    invoke-static {v0, v3}, Lhmw;->a(II)V
    :try_end_5
    .catch Lhmx; {:try_start_5 .. :try_end_5} :catch_4
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_1

    :goto_3
    :try_start_6
    iget-wide v4, p0, Lhmw;->c:J
    ...
    iput-object v0, v2, Lbox;->x:Ljava/lang/Long;

    :cond_1
    iget-wide v4, p0, Lhmw;->d:J
    ...
    iput-object v0, v2, Lbox;->w:Ljava/lang/Long;

    :cond_2
    iget-wide v4, p0, Lhmw;->e:J
    ...
    iput-object v0, v2, Lbox;->v:Ljava/lang/Long;

    :cond_3
    iget-wide v4, p0, Lhmw;->f:J
    ...
    iput-object v0, v2, Lbox;->y:Ljava/lang/Long;
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_1

    :cond_4
    :try_start_7
    iget-object v0, p0, Lhmw;->b:Ljava/util/LinkedList;
    ...
    new-array v0, v3, [Lboy;

    iput-object v0, v2, Lbox;->z:[Lboy;
    ...
    iget-object v4, p0, Lhmw;->g:Landroid/util/DisplayMetrics;

    invoke-static {v0, v4}, Lhmw;->a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    iput-object v0, v5, Lboy;->a:Ljava/lang/Long;
    ...
    iput-object v0, v5, Lboy;->b:Ljava/lang/Long;

    iget-object v0, v2, Lbox;->z:[Lboy;

    aput-object v5, v0, v1
    :try_end_7
    .catch Lhmx; {:try_start_7 .. :try_end_7} :catch_0
    ...
    iput-object v0, v2, Lbox;->r:Ljava/lang/String;
    :try_end_9
    .catch Lhmx; {:try_start_9 .. :try_end_9} :catch_3
    ...
    iput-object v0, v2, Lbox;->s:Ljava/lang/Long;
    :try_end_a
    .catch Lhmx; {:try_start_a .. :try_end_a} :catch_2
