...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgws;->b:Landroid/content/ComponentName;
...
.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgwx;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lhfe;->a(Landroid/content/Context;)Lhfe;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lhfe;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lhgy;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgwx;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lhfe;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lhbb;->d(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lgwy;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lhay;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lgwq;-><init>(Ljava/lang/String;)V
...
.method static c(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-static {p0}, Lhax;->c(Landroid/content/Context;)V
