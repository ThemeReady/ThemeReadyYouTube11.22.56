...
# direct methods
.method constructor <init>(Lldy;Lkzu;)V
    .locals 1
    ...
    iput-object v0, p0, Llim;->b:Lkzu;

    .line 62
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lauv;)V
    .locals 2

    .prologue
    .line 180
    invoke-virtual {p1}, Lauv;->q()[B
...
# virtual methods
.method public final a(Lauv;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 74
    invoke-virtual {p1}, Lauv;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lauv;->l()Ljava/lang/String;
    ...
    .line 83
    :goto_1
    invoke-static {v2, p2}, Llim;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 84
    invoke-virtual {p1}, Lauv;->i()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Llim;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-interface {v3}, Lavd;->ae_()I
    ...
    .line 2109
    sget-object v5, Llin;->a:[I

    invoke-virtual {v3}, Laux;->ordinal()I
    ...
    .line 93
    iget-object v3, p0, Llim;->b:Lkzu;

    invoke-virtual {v3, v1}, Lkzu;->d(Ljava/lang/Object;)V

    .line 3104
    :cond_0
    iget-object v1, p0, Llim;->a:Lldy;
    ...
    .line 97
    iget-object v2, p0, Llim;->b:Lkzu;

    invoke-virtual {v2, v0}, Lkzu;->d(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lauv;->p()Ljava/lang/String;
    ...
    .line 1151
    invoke-static {v2, p1}, Llim;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lauv;)V
    ...
    invoke-direct {v2, v3}, Lavr;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lavr;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
