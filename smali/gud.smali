...
.field private volatile b:Lgvv;

.field private volatile c:Z


# direct methods
.method protected constructor <init>(Lgub;)V
    .locals 0
...
.method public final a()Lgvv;
    ...
    iget-object v2, p0, Lgud;->a:Lgub;

    .line 3000
    iget-object v2, v2, Lgtw;->b:Lgtx;
    ...
    :try_start_0
    iput-object v4, p0, Lgud;->b:Lgvv;

    const/4 v4, 0x1

    iput-boolean v4, p0, Lgud;->c:Z

    iget-object v4, p0, Lgud;->a:Lgub;

    .line 5000
    iget-object v4, v4, Lgub;->a:Lgud;

    .line 0
    const/16 v5, 0x81

    invoke-virtual {v3, v2, v1, v4, v5}, Lhgc;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual {v2, v3, v4}, Lgub;->a(Ljava/lang/String;Ljava/lang/Object;)V

    if-nez v1, :cond_0

    const/4 v1, 0x0

    iput-boolean v1, p0, Lgud;->c:Z
    ...
    :try_start_2
    iput-boolean v0, p0, Lgud;->c:Z

    iget-object v0, p0, Lgud;->b:Lgvv;

    const/4 v1, 0x0

    iput-object v1, p0, Lgud;->b:Lgvv;
    ...
    invoke-virtual {v1, v2}, Lgub;->e(Ljava/lang/String;)V
    ...
    :try_start_3
    iget-object v0, p0, Lgud;->a:Lgub;

    const-string v1, "Wait for service connect was interrupted"

    invoke-virtual {v0, v1}, Lgub;->d(Ljava/lang/String;)V
    :try_end_3
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v1}, Lgub;->e(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-virtual {v1, v2}, Lgub;->b(Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-direct {v0, p2}, Lgvx;-><init>(Landroid/os/IBinder;)V
    :try_end_6
    ...
    invoke-virtual {v2, v3, v0}, Lgub;->d(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_9
    ...
    invoke-virtual {v1, v2}, Lgub;->d(Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v0}, Lgue;-><init>(Lgud;Lgvv;)V

    invoke-virtual {v1, v2}, Liaf;->a(Ljava/lang/Runnable;)V

    goto :goto_3

    :cond_5
    iput-object v0, p0, Lgud;->b:Lgvv;
    :try_end_a
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-direct {v1, p0, p1}, Lguf;-><init>(Lgud;Landroid/content/ComponentName;)V
