...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljrt;->ah:Landroid/content/Intent;
...
.method static a(Ltey;)Ljrt;
    ...
    .line 92
    invoke-virtual {v1, v0}, Ljrt;->f(Landroid/os/Bundle;)V
...
.method private final varargs a([Ljava/lang/String;)Z
    ...
    .line 595
    iget-object v0, p0, Ljrt;->ac:Landroid/content/SharedPreferences;
    ...
    .line 617
    :cond_7
    iget-object v1, p0, Ljrt;->ac:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v0, v1}, Ljrt;->a([Ljava/lang/String;I)V
...
.method private final x()V
    ...
    .line 216
    :cond_1
    iget-object v0, p0, Ljrt;->ad:Luvs;
    ...
    invoke-virtual {p0, v0}, Ljrt;->a(Luvs;)V

    goto :goto_0

    .line 218
    :cond_2
    iget-boolean v0, p0, Ljrt;->ak:Z

    if-nez v0, :cond_5

    .line 5360
    iget-object v0, p0, Ljrt;->ai:Ltey;
    ...
    .line 5377
    invoke-virtual {p0}, Ljrt;->g()Landroid/content/res/Resources;
    ...
    invoke-direct {v1, v2}, Ljrs;-><init>(Ljava/lang/String;)V

    .line 5376
    invoke-virtual {p0, v0, v1}, Ljrt;->a(Ljava/lang/String;Ljrs;)V
    ...
    .line 5382
    :goto_1
    sget-object v1, Ljrt;->ah:Landroid/content/Intent;
    ...
    .line 5388
    invoke-virtual {p0, v0, v4}, Ljrt;->a(Landroid/content/Intent;I)V
    ...
    invoke-direct {p0, v0}, Ljrt;->a([Ljava/lang/String;)Z
    ...
    .line 5448
    sget-object v0, Ljrt;->ah:Landroid/content/Intent;
    ...
    .line 5454
    invoke-virtual {p0}, Ljrt;->e()Landroid/content/Context;
    ...
    invoke-static {v3}, Ljsf;->a(Landroid/content/Context;)Ljava/io/File;
    ...
    iput-object v1, p0, Ljrt;->aj:Landroid/net/Uri;

    .line 5457
    const-string v1, "output"

    iget-object v2, p0, Ljrt;->aj:Landroid/net/Uri;
    ...
    iget-object v3, p0, Ljrt;->aj:Landroid/net/Uri;
    ...
    .line 5368
    invoke-virtual {p0, v1, v0}, Ljrt;->a(Ljava/lang/String;Ljrs;)V
    ...
    .line 220
    :cond_5
    iget-boolean v0, p0, Ljrt;->al:Z

    if-nez v0, :cond_6

    .line 221
    invoke-direct {p0}, Ljrt;->y()V

    goto/16 :goto_0

    .line 223
    :cond_6
    invoke-direct {p0}, Ljrt;->z()V
...
.method private final y()V
    ...
    iget-object v0, v0, Ltey;->c:Ltez;

    if-nez v0, :cond_0

    .line 399
    iget-object v0, p0, Ljrt;->aj:Landroid/net/Uri;

    iput-object v0, p0, Ljrt;->ae:Landroid/net/Uri;
    ...
    invoke-static {v2}, Ljsf;->a(Landroid/content/Context;)Ljava/io/File;
    ...
    iput-object v2, p0, Ljrt;->ae:Landroid/net/Uri;

    .line 5469
    const-string v2, "output"

    iget-object v3, p0, Ljrt;->ae:Landroid/net/Uri;
    ...
    iget-object v2, p0, Ljrt;->ai:Ltey;

    iget-object v3, p0, Ljrt;->a:Ljrq;

    .line 5497
    invoke-interface {v3}, Ljrq;->g()Lsyw;

    move-result-object v3

    .line 6295
    iget-object v4, v2, Ltey;->e:Landroid/text/Spanned;

    if-nez v4, :cond_6

    .line 6296
    iget-object v4, v2, Ltey;->d:Ltca;
    ...
    iput-object v3, v2, Ltey;->e:Landroid/text/Spanned;

    .line 6300
    :cond_6
    iget-object v2, v2, Ltey;->e:Landroid/text/Spanned;
    ...
    invoke-virtual {p0, v1, v0}, Ljrt;->a(Landroid/content/Intent;I)V
    :try_end_0
    .catch Ljrs; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final z()V
    ...
    .line 419
    iget-object v0, p0, Ljrt;->ae:Landroid/net/Uri;
...
.method public final a(IILandroid/content/Intent;)V
    ...
    .line 180
    iget-object v1, p0, Ljrt;->ai:Ltey;

    iget-object v1, v1, Ltey;->c:Ltez;
    ...
    invoke-direct {v3, v0}, Ljrs;-><init>(Ljava/lang/String;)V

    .line 181
    invoke-virtual {p0, v2, v3}, Ljrt;->a(Ljava/lang/String;Ljrs;)V
    ...
    :goto_1
    iput-object v0, p0, Ljrt;->aj:Landroid/net/Uri;
...
.method public final a(I[I)V
    ...
    .line 210
    :cond_2
    invoke-direct {p0}, Ljrt;->x()V

    goto :goto_2
.end method

.method final a(Ljava/lang/String;Ljrs;)V
    .locals 1
    ...
    .line 564
    iget-object v0, p0, Ljrt;->ab:Llkp;

    invoke-interface {v0, p1}, Llkp;->a(Ljava/lang/String;)V

    .line 565
    iget-object v0, p0, Ljrt;->a:Ljrq;

    invoke-interface {v0, p2}, Ljrq;->a(Ljava/lang/Throwable;)V

    .line 566
    return-void
.end method

.method final a(Luvs;)V
    .locals 4
    ...
    iput-object v0, p0, Ljrt;->ad:Luvs;

    .line 256
    iget-object v0, p0, Ljrt;->af:Ljava/lang/String;

    if-eqz v0, :cond_0

    .line 257
    invoke-virtual {p0}, Ljrt;->v()V
    ...
    .line 261
    :cond_0
    iget-object v0, p1, Luvs;->a:Ljava/lang/String;

    .line 262
    iget-object v1, p1, Luvs;->g:Ljava/lang/String;
    ...
    .line 265
    :cond_1
    invoke-virtual {p1}, Luvs;->c()Landroid/text/Spanned;
    ...
    .line 271
    :cond_2
    iget-object v2, p0, Ljrt;->c:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v3, Ljru;

    invoke-direct {v3, p0, v1, v0, p1}, Ljru;-><init>(Ljrt;Ljava/lang/String;Ljava/lang/String;Luvs;)V
...
.method public final d(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0}, Ljsb;->a(Ljrt;)V
    ...
    .line 1331
    iput-object v0, p0, Ljrt;->ai:Ltey;
    :try_end_0
    ...
    iput-object v0, p0, Ljrt;->af:Ljava/lang/String;

    .line 3343
    const-string v0, "arg_get_photo_finished"

    iget-boolean v1, p0, Ljrt;->ak:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Ljrt;->ak:Z

    .line 3344
    const-string v0, "arg_crop_photo_finished"

    iget-boolean v1, p0, Ljrt;->al:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Ljrt;->al:Z

    .line 3345
    const-string v0, "arg_dismissed"

    iget-boolean v1, p0, Ljrt;->ag:Z
...
.method public final e(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Ljrt;->aj:Landroid/net/Uri;
    ...
    iget-object v1, p0, Ljrt;->ae:Landroid/net/Uri;
    ...
    iget-object v1, p0, Ljrt;->af:Ljava/lang/String;
    ...
    iget-object v1, p0, Ljrt;->ad:Luvs;

    .line 163
    invoke-static {v1}, Luvs;->a(Lwbx;)[B
...
.method final v()V
    ...
    iget-object v0, v0, Luvs;->c:Ltvj;

    if-eqz v0, :cond_0

    .line 504
    iget-object v0, p0, Ljrt;->Z:Lsyw;

    iget-object v1, p0, Ljrt;->ad:Luvs;

    iget-object v1, v1, Luvs;->c:Ltvj;
...
.method final w()V
    ...
    iget-object v0, v0, Luvs;->d:Luqm;

    if-eqz v0, :cond_0

    .line 519
    iget-object v0, p0, Ljrt;->c:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v1, Ljry;

    invoke-direct {v1, p0}, Ljry;-><init>(Ljrt;)V
