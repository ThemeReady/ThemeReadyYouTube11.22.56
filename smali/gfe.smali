...
.method public final a(Lgfi;Lgfc;)V
    ...
    .line 75
    :goto_0
    iget-object v0, v5, Lgfl;->b:Ljava/util/List;
    ...
    .line 80
    iget-boolean v3, p0, Lgfe;->c:Z

    if-eqz v3, :cond_6

    .line 81
    iget-object v6, p0, Lgfe;->b:Landroid/content/Context;

    iget-object v7, v0, Lgff;->b:Ljava/util/List;

    iget-boolean v3, p0, Lgfe;->d:Z
    ...
    invoke-static {v7, v6, v3, v8, v0}, Lget;->a(Ljava/util/List;[Ljava/lang/String;ZII)[I
    ...
    invoke-interface {p2, p1, v2, v1, v7}, Lgfc;->a(Lgfi;III)V
