...
.method public final a(Lfxa;Lfxm;Lfxs;Lfxv;Lfwx;Lfwu;Lfxy;Lfxd;Lfxj;Lfxp;Lfyb;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    ...
    invoke-interface {p1}, Lfxa;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lfxm;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lfxs;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lfxv;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lfwx;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lfwu;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lfxy;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lfxd;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lfxj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lfxp;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lfyb;->asBinder()Landroid/os/IBinder;
