...
.method private native nativeCreateGpuBuffer(JIIILini;)J
.end method


# virtual methods
.method public final a(Linh;)Lcom/google/android/libraries/drishti/framework/DrishtiPacket;
    .locals 8
    ...
    .line 196
    invoke-interface {p1}, Linh;->a()I

    move-result v4

    .line 197
    invoke-interface {p1}, Linh;->b()I

    move-result v5

    invoke-interface {p1}, Linh;->c()I
    ...
    .line 195
    invoke-direct/range {v1 .. v7}, Lcom/google/android/libraries/drishti/framework/DrishtiPacketCreator;->nativeCreateGpuBuffer(JIIILini;)J
