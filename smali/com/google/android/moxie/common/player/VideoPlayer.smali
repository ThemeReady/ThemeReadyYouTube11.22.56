...
.field private x:Lgbr;

.field private y:Lgcv;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lvty;)V
    .locals 4
    ...
    invoke-direct {v0, p0}, Lvtv;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lvtw;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lgbr;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lgcv;

    .line 162
    iput-object p1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->e:Landroid/content/Context;

    .line 163
    iput-object p2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->b:Lvty;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgbo;

    .line 165
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgbo;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lgbr;
    ...
    invoke-interface {v0, v3}, Lgbo;->a(Z)V

    .line 167
    new-instance v0, Lgoq;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgbo;

    invoke-direct {v0, v1}, Lgoq;-><init>(Lgbo;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgoq;
...
.method public static create(Landroid/content/Context;Lvty;)Lcom/google/android/moxie/common/player/VideoPlayer;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/moxie/common/player/VideoPlayer;-><init>(Landroid/content/Context;Lvty;)V
...
.method public close()V
    ...
    .line 270
    iput-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lgdi;
...
.method public getPlayerControl()Lgoq;
    .locals 1

    .prologue
    .line 386
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgoq;
...
.method public open(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvtu;
    ...
    iget-object v3, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvtu;

    iget-object v6, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lgcv;

    invoke-static/range {v0 .. v6}, Lvtz;->a(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;Lgbx;Ljava/lang/String;ILgcv;)Lvtz;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lgdi;

    .line 2222
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lgdi;
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lgdi;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->m:Landroid/view/Surface;

    invoke-interface {v0, v1, v7, v2}, Lgbo;->a(Lgbp;ILjava/lang/Object;)V

    .line 2226
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgbo;

    new-array v1, v7, [Lgdi;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lgdi;
...
.method public pause()V
    ...
    .line 306
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lvtu;
...
.method public play(JJZ)V
    ...
    .line 287
    :cond_1
    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgbo;

    invoke-interface {v2}, Lgbo;->f()J
...
.method public update(J)Z
    ...
    .line 3048
    iput-wide v2, v0, Lvtu;->a:J

    .line 3049
    invoke-static {v2, v3}, Lvtu;->a(J)J

    move-result-wide v2

    iput-wide v2, v0, Lvtu;->b:J
