...
# direct methods
.method constructor <init>(Lhbm;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;)V
    .locals 0

    iput-object p2, p0, Lhlj;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    invoke-direct {p0, p1}, Lihj;-><init>(Lhbm;)V
...
# virtual methods
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Lhbv;
    .locals 2
    ...
    invoke-direct {v1, p1, v0}, Lihq;-><init>(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;)V
...
.method protected final synthetic a(Lhbj;)V
    ...
    .line 1000
    iget-object v1, p0, Lhlj;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    .line 2000
    new-instance v2, Lhlh;

    invoke-direct {v2, p0}, Lhlh;-><init>(Lhcc;)V

    .line 3000
    iget v0, p1, Lhlf;->b:I

    iget-object v3, p1, Lhlf;->a:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lhlf;->c:Ljava/lang/String;

    iget v5, p1, Lhlf;->d:I

    iget-boolean v6, p1, Lhlf;->e:Z
    ...
    .line 2000
    :try_start_0
    invoke-virtual {p1}, Lhlf;->l()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhkv;

    invoke-interface {v0, v1, v7, v2}, Lhkv;->a(Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;Landroid/os/Bundle;Lhlb;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v0, v3}, Lhlh;->a(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;Landroid/os/Bundle;)V
