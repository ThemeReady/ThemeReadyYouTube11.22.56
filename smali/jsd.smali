...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljsd;->a:Ljava/nio/charset/Charset;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljqf;Lpkr;)V
    .locals 1
    ...
    iput-object v0, p0, Ljsd;->b:Landroid/content/Context;
...
.method private static a(Lwdb;)Ljava/lang/String;
    ...
    .line 6034
    :try_start_1
    iget-object v1, v1, Lwcf;->c:Ljava/io/InputStream;
    ...
    :cond_4
    :try_start_2
    invoke-static {v1}, Llan;->a(Ljava/io/InputStream;)[B
    :try_end_2
    ...
    invoke-static {v2, v0, v1}, Ljsd;->a(ILwce;[B)Laus;
    ...
    sget-object v5, Ljsd;->a:Ljava/nio/charset/Charset;
...
.method private final a(Ljrm;Ljava/lang/String;Ljava/lang/String;)Lwdb;
    .locals 8
    ...
    .line 160
    :try_start_1
    new-instance v4, Lwcm;

    new-instance v0, Ljava/io/BufferedInputStream;

    iget-object v1, p0, Ljsd;->b:Landroid/content/Context;
    ...
    .line 1073
    iget-object v2, p1, Ljrm;->a:Landroid/net/Uri;
    ...
    .line 2069
    iget-wide v6, p1, Ljrm;->c:J

    .line 162
    const/high16 v1, 0x100000

    invoke-direct {v4, v0, v6, v7, v1}, Lwcm;-><init>(Ljava/io/InputStream;JI)V
    :try_end_1
    ...
    .line 3065
    iget-object v1, p1, Ljrm;->b:Ljava/security/MessageDigest;

    .line 4055
    iput-object v1, v0, Lwdh;->b:Ljava/security/MessageDigest;
    ...
    invoke-direct {v1, v0}, Ljrs;-><init>(Ljava/lang/Throwable;)V
...
.method public final a(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Ljsd;->b:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    invoke-static {v0, p1}, Ljrm;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljrm;
    :try_end_0
    ...
    .line 103
    invoke-direct {p0, v0, p2, p3}, Ljsd;->a(Ljrm;Ljava/lang/String;Ljava/lang/String;)Lwdb;

    move-result-object v0

    .line 106
    :try_start_1
    invoke-static {v0}, Ljsd;->a(Lwdb;)Ljava/lang/String;
    :try_end_1
    .catch Laur; {:try_start_1 .. :try_end_1} :catch_1
    .catch Lave; {:try_start_1 .. :try_end_1} :catch_2
