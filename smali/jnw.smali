...
# instance fields
.field private a:Ljtn;

.field private b:Ljtk;
...
.method public a(Landroid/app/Activity;[B)V
    ...
    .line 103
    :cond_1
    invoke-static {p2}, Ljnx;->a([B)Ljnx;
...
.method public final a(Landroid/app/Activity;[BLjtk;)V
    ...
    .line 77
    sget-object p3, Ljtk;->c:Ljtk;

    .line 78
    :cond_2
    iput-object p3, p0, Ljnw;->b:Ljtk;

    .line 1087
    invoke-virtual {p0, p1, p2}, Ljnw;->a(Landroid/app/Activity;[B)V
...
.method public handleSignInEvent(Lpkx;)V
    ...
    invoke-interface {v0}, Ljtk;->a()V

    .line 114
    const/4 v0, 0x0

    iput-object v0, p0, Ljnw;->b:Ljtk;
...
.method public handleSignInFailureEvent(Ljtv;)V
    .locals 2
    .annotation runtime Llag;
    .end annotation
    ...
    .line 2018
    iget-object v1, p1, Ljtv;->a:Ljava/lang/Exception;

    .line 122
    invoke-interface {v0, v1}, Ljtk;->a(Ljava/lang/Exception;)V
