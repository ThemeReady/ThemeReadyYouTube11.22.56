...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1552
    invoke-direct {v0, p0}, Lake;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    .line 228
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lake;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lamu;

    .line 231
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Lamu;

    invoke-virtual {v0}, Lamu;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lake;
    ...
    invoke-direct {v2, p0, v0}, Lakb;-><init>(Landroid/support/v7/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    .line 1637
    invoke-direct {v0, p0}, Lakd;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    .line 263
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    .line 264
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    new-instance v1, Lakc;

    invoke-direct {v1, p0}, Lakc;-><init>(Landroid/support/v7/widget/ActivityChooserView;)V

    invoke-virtual {v0, v1}, Lakd;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method public final a(I)V
    ...
    .line 355
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    .line 3798
    iget-object v3, v3, Lakd;->a:Laju;
    ...
    invoke-virtual {v3, v1}, Lakd;->a(Z)V
    ...
    invoke-virtual {v3, v4}, Lakd;->a(I)V

    .line 366
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->d()Lane;

    move-result-object v3

    .line 4786
    iget-object v4, v3, Lane;->e:Landroid/widget/PopupWindow;
    ...
    .line 369
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    invoke-virtual {v2, v1, v0}, Lakd;->a(ZZ)V

    .line 373
    :goto_3
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    invoke-virtual {v0}, Lakd;->a()I
    ...
    .line 374
    invoke-virtual {v3, v0}, Lane;->a(I)V

    .line 375
    invoke-virtual {v3}, Lane;->b()V

    .line 376
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->h:Lqb;
    ...
    invoke-virtual {v3, v2}, Lakd;->a(Z)V

    .line 363
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;

    invoke-virtual {v3, p1}, Lakd;->a(I)V
    ...
    invoke-virtual {v0, v2, v2}, Lakd;->a(ZZ)V
...
.method public final d()Lane;
    .locals 2

    .prologue
    .line 503
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lane;
    ...
    invoke-direct {v0, v1}, Lane;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lane;

    .line 505
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->p:Lane;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Lakd;
    ...
    .line 8445
    iput-object p0, v0, Lane;->n:Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->m:Lake;

    .line 8564
    iput-object v1, v0, Lane;->o:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    invoke-virtual {v0, v1}, Lane;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method protected final onAttachedToWindow()V
    ...
    invoke-virtual {v0, v1}, Laju;->registerObserver(Ljava/lang/Object;)V
...
.method protected final onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Laju;->unregisterObserver(Ljava/lang/Object;)V
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v3, v3, v1, v2}, Lamu;->layout(IIII)V
