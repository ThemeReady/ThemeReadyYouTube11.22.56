...
.field public static final HIDDEN_METHOD_INVOKER:Lapw;
...
.field private mOnCloseListener:Lapx;
...
.field private mOnQueryChangeListener:Lapy;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Lapz;
...
.field private mSuggestionsAdapter:Lwr;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lapw;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 278
    invoke-direct {p0, p1, p2, p3}, Lamu;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 172
    new-instance v0, Lapk;

    invoke-direct {v0, p0}, Lapk;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapo;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapp;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapt;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapu;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapv;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapl;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapm;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapn;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mDrawableManager:Lakn;

    .line 282
    sget-object v0, Lade;->bg:[I
    ...
    invoke-virtual {v1, v2, v3}, Laqm;->e(II)I
    ...
    invoke-virtual {v1, v2}, Laqm;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Laqm;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v2}, Laqm;->e(II)I
    ...
    invoke-direct {v2, p0}, Lapq;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Laqm;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Laqm;->c(II)I
    ...
    invoke-virtual {v1, v0}, Laqm;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v4}, Laqm;->a(II)I
    ...
    .line 3181
    iget-object v0, v1, Laqm;->a:Landroid/content/res/TypedArray;
...
.method public static synthetic access$100(Landroid/support/v7/widget/SearchView;)Lwr;
    .locals 1

    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwr;
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    invoke-direct {v1, p0}, Laps;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Lapr;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Laqe;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Laqe;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lapw;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 6843
    iget-object v2, v0, Lapw;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 6845
    :try_start_0
    iget-object v0, v0, Lapw;->a:Ljava/lang/reflect/Method;
    ...
    .line 6852
    iget-object v2, v0, Lapw;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 6854
    :try_start_1
    iget-object v0, v0, Lapw;->b:Ljava/lang/reflect/Method;
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    .line 6194
    iget-object v0, v0, Lwr;->c:Landroid/database/Cursor;
...
.method private onCloseClicked()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapx;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapx;

    invoke-interface {v0}, Lapx;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1351
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapz;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapz;

    invoke-interface {v1}, Lapz;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1362
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapz;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapz;

    invoke-interface {v0}, Lapz;->a()Z
...
.method private onSubmitQuery()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapy;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p3}, Lqi;->a(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Lapw;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1149
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapy;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    .line 1405
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwr;

    .line 5194
    iget-object v1, v1, Lwr;->c:Landroid/database/Cursor;
    ...
    .line 1411
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwr;

    invoke-virtual {v2, v1}, Lwr;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-virtual {v0, v2}, Lwr;->a(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Laqe;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwr;
...
.method public clearFocus()V
    ...
    .line 513
    invoke-super {p0}, Lamu;->clearFocus()V
...
.method public getSuggestionsAdapter()Lwr;
    .locals 1
...
.method protected onDetachedFromWindow()V
    ...
    .line 920
    invoke-super {p0}, Lamu;->onDetachedFromWindow()V
...
.method protected onMeasure(II)V
    ...
    .line 785
    invoke-super {p0, p1, p2}, Lamu;->onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lamu;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1317
    invoke-super {p0, p1}, Lamu;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1321
    invoke-virtual {p1}, Laqa;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Lamu;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 1322
    iget-boolean v0, p1, Laqa;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 1308
    invoke-super {p0}, Lamu;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Laqa;-><init>(Landroid/os/Parcelable;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    .prologue
    .line 1238
    invoke-super {p0, p1}, Lamu;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 504
    :cond_3
    invoke-super {p0, p1, p2}, Lamu;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Lapx;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapx;
...
.method public setOnQueryTextListener(Lapy;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapy;
...
.method public setOnSuggestionListener(Lapz;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapz;
...
.method public setSuggestionsAdapter(Lwr;)V
    .locals 2

    .prologue
    .line 750
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwr;
