...
# direct methods
.method public constructor <init>(Lldy;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Llcw;-><init>(Lldy;)V

    iput-object v0, p0, Lldd;->a:Llcw;
    ...
    iput-object v0, p0, Lldd;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Lldd;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lwbm;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lwbl;
    .locals 3
...
# virtual methods
.method public final a(Llnm;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Lldd;->b:Landroid/net/Uri;
    ...
    iget-object v3, p0, Lldd;->c:Ljava/lang/String;
    ...
    invoke-virtual {v2, v1}, Llei;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v1}, Lldd;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Llnm;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Lldd;->a:Llcw;

    invoke-virtual {v1, v2}, Llcw;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Lldd;->a(Lorg/apache/http/HttpResponse;)Lwbm;

    move-result-object v1

    .line 65
    iget-object v1, v1, Lwbm;->a:[Ljava/lang/String;
    ...
    .catch Llpz; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Llnm;->a:Llno;

    .line 2135
    iget-wide v2, v1, Llno;->c:J
...
.method public final a(Llcx;Llnm;)Lldj;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Lldd;->b:Landroid/net/Uri;
    ...
    .line 3021
    iget-object v2, p1, Llcx;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Llei;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Lldd;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Llnm;->b()J
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Lldd;->a:Llcw;

    invoke-virtual {v0, v2}, Llcw;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Lldd;->b(Lorg/apache/http/HttpResponse;)Lwbl;
    ...
    iget-object v2, v1, Lwbl;->a:[Lwbj;

    iget-wide v4, v1, Lwbl;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Lldj;-><init>(Llcx;[Lwbj;J)V
