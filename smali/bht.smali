...
.method public constructor <init>(Landroid/content/Context;Lbbg;Lbbb;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lbht;-><init>(Landroid/content/Context;Lbbg;Lbbb;Lbhv;Lbhu;)V

    .line 60
    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lbbg;Lbbb;Lbhv;Lbhu;)V
    .locals 1
    ...
    .line 70
    iput-object p2, p0, Lbht;->f:Lbbg;

    .line 72
    new-instance v0, Lbhw;

    invoke-direct {v0, p2, p3}, Lbhw;-><init>(Lbbg;Lbbb;)V
...
.method private final a(Ljava/nio/ByteBuffer;II)Lbia;
    ...
    invoke-virtual {v1, p1}, Lbhv;->a(Ljava/nio/ByteBuffer;)Laxf;
    ...
    .line 2064
    iget-object v1, v8, Laxf;->b:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v1, v8}, Lbhv;->a(Laxf;)V
    ...
    invoke-direct {v2, v4, v3, p1, v1}, Laxg;-><init>(Laxc;Laxe;Ljava/nio/ByteBuffer;I)V

    .line 1105
    invoke-interface {v2}, Laxb;->b()V

    .line 1106
    invoke-interface {v2}, Laxb;->g()Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Lbht;->f:Lbbg;

    move v5, p2

    move v6, p3

    invoke-direct/range {v0 .. v7}, Lbhx;-><init>(Landroid/content/Context;Laxb;Lbbg;Laya;IILandroid/graphics/Bitmap;)V
...
.method public final synthetic a(Ljava/lang/Object;Laxx;)Z
    ...
    .line 7079
    sget-object v0, Lbht;->b:Laxu;

    invoke-virtual {p2, v0}, Laxx;->a(Laxu;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/nio/ByteBuffer;Lbbb;)V
