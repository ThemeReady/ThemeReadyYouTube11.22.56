...
# instance fields
.field private g:Lpyk;


# direct methods
.method private constructor <init>(Llax;Ljava/security/Key;Llax;Lrlp;Llmu;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrlq;-><init>(Ljava/security/Key;Llax;Lrlp;)V

    .line 67
    new-instance v0, Lpyk;

    invoke-direct {v0, p2, p5, p1}, Lpyk;-><init>(Ljava/security/Key;Llmu;Llax;)V

    iput-object v0, p0, Lpxr;->g:Lpyk;

    .line 1152
    iget-object v0, p0, Lrlq;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lpxr;->g:Lpyk;
...
.method public static a(Llax;Ljava/security/Key;Llax;Lrlp;Llmu;)Lpxr;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lpxr;-><init>(Llax;Ljava/security/Key;Llax;Lrlp;Llmu;)V
    ...
    iput-object v1, v0, Lrlq;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrlq;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrlq;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrlq;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrlr;

    invoke-direct {v2, v0}, Lrlr;-><init>(Lrlq;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    .line 1160
    iget-object v1, p0, Lrlq;->e:Ljava/net/ServerSocket;
    ...
    .line 2156
    iget-object v1, p0, Lrlq;->d:Lrmj;

    .line 90
    invoke-virtual {v1, v0}, Lrmj;->a(Landroid/net/Uri;)Landroid/net/Uri;
