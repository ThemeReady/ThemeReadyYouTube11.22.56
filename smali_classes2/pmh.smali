...
.field private synthetic d:Lpmg;
...
.method public final declared-synchronized a(Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v1, p0, Lpmh;->d:Lpmg;

    .line 1020
    iget-object v1, v1, Lpmg;->a:Landroid/net/Uri;
    :try_end_0
    ...
    .line 91
    :try_start_2
    iget-object v1, p0, Lpmh;->c:Lpoh;

    iget-object v2, p0, Lpmh;->d:Lpmg;

    .line 2020
    iget-object v2, v2, Lpmg;->a:Landroid/net/Uri;
    ...
    :try_end_2
    .catch Llpz; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-virtual {v1}, Llpz;->toString()Ljava/lang/String;
