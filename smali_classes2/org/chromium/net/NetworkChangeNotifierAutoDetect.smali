...
.method public constructor <init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect$Observer;Landroid/content/Context;Lorg/chromium/net/NetworkChangeNotifierAutoDetect$RegistrationPolicy;)V
    ...
    invoke-direct {v0, p2}, Lwth;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lwth;

    .line 547
    new-instance v0, Lwtq;

    invoke-direct {v0, p2}, Lwtq;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->i:Lwtq;
    ...
    .line 1282
    invoke-direct {v0, p0}, Lwti;-><init>(Lorg/chromium/net/NetworkChangeNotifierAutoDetect;)V

    .line 549
    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lwti;
    ...
    .line 559
    :goto_0
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e:Lwth;

    invoke-virtual {v0}, Lwth;->a()Lwtp;

    move-result-object v0

    .line 560
    invoke-static {v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lwtp;)I
    ...
    .line 561
    invoke-direct {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f(Lwtp;)Ljava/lang/String;
    ...
    .line 562
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lwtp;)D
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->i:Lwtq;

    .line 2273
    iget-boolean v1, v1, Lwtq;->c:Z

    .line 564
    invoke-direct {v0, v1}, Lwto;-><init>(Z)V

    iput-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a:Lwto;
    ...
    .line 556
    :cond_0
    iput-object v2, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lwti;
...
.method public static a(Lwth;Landroid/net/Network;)[Landroid/net/Network;
    .locals 8
    ...
    .line 4125
    iget-object v0, p0, Lwth;->a:Landroid/net/ConnectivityManager;
    ...
    .line 663
    invoke-virtual {p0, v6}, Lwth;->c(Landroid/net/Network;)Landroid/net/NetworkCapabilities;
    ...
    .line 670
    invoke-static {v6}, Lwth;->b(Landroid/net/Network;)Z
...
.method private final f(Lwtp;)Ljava/lang/String;
    .locals 4

    .prologue
    .line 840
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->a(Lwtp;)I
    ...
    .line 841
    :cond_1
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->i:Lwtq;

    .line 7244
    iget-object v0, v0, Lwtq;->a:Landroid/content/Context;
...
.method public final a()V
    ...
    .line 639
    iget-object v0, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lwti;
    ...
    iget-object v1, p0, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f:Lwti;

    .line 3173
    iget-object v0, v0, Lwth;->a:Landroid/net/ConnectivityManager;
...
.method public final c(Lwtp;)D
    ...
    .line 6263
    iget-boolean v2, v0, Lwtq;->c:Z

    if-eqz v2, :cond_0

    iget-object v2, v0, Lwtq;->b:Landroid/net/wifi/WifiManager;
    ...
    .line 6264
    :cond_1
    iget-object v0, v0, Lwtq;->b:Landroid/net/wifi/WifiManager;
    ...
    .line 835
    :cond_3
    invoke-static {p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->b(Lwtp;)I
...
.method final d(Lwtp;)V
    ...
    .line 858
    invoke-direct {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->f(Lwtp;)Ljava/lang/String;
...
.method final e(Lwtp;)V
    .locals 4

    .prologue
    .line 868
    invoke-virtual {p0, p1}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->c(Lwtp;)D
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 849
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->d(Lwtp;)V

    .line 850
    invoke-virtual {p0, v0}, Lorg/chromium/net/NetworkChangeNotifierAutoDetect;->e(Lwtp;)V
